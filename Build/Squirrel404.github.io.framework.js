...
var ASM_CONSTS = {
  5129440: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 5129501: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 5129565: function() {return Module.webglContextAttributes.powerPreference;},  
 5129623: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 5129678: function($0) {performance.now = function() { return $0; };},  
 5129726: function($0) {performance.now = function() { return $0; };},  
 5129774: function() {performance.now = Module['emscripten_get_now_backup'];}
};
...
var asmLibraryArg = {
  ...
  "OnMedalUnlocked": _OnMedalUnlocked,
  "OnScorePosted": _OnScorePosted,
